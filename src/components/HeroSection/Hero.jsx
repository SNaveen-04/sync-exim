      ...
      <Carousel>
        <div style={{backgroundImage:`url(${Image1})`}} className="h-full w-full bg-gray-400 dark:bg-gray-700 dark:text-white bg-no-repeat bg-cover bg-center bg-scroll cursor-default">
          <div className="h-full w-full flex flex-col justify-center bg-black bg-opacity-55">
            ...
            <h1 className="px-10 my-2 text-white text-2xl font-semibold">
              Global quality products exported from India
            </h1>
            <p className="text-left px-10 my-2 text-white text-xl font-semibold">&quot;Export Excellence&quot;</p>
            <div className="px-10 py-2">
              <a className="inline-flex items-center tracking-wide font-bold p-[15px] bg-[#4AB9CF] text-white m-[10px] gap-[2px] cursor-pointer hover:bg-[#2c526e]">Service we provide<FaArrowRight/></a>            
              <a className="inline-flex items-center tracking-wide font-bold p-[15px] border border-white text-white m-[10px] gap-[2px] cursor-pointer hover:bg-[#2c526e] hover:border-[#2c526e]">Learn More<FaArrowRight/></a>            
            </div>
          </div>
        </div>
